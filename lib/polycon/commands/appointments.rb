      ...
      class Create < Dry::CLI::Command
        ...
        def call(date:, professional:, name:, surname:, phone:, notes: nil)
          begin
            ...
            puts "Se creo el turno exitosamente"
          rescue => exception
      ...
      class Show < Dry::CLI::Command
        ...
        def call(date:, professional:)
          begin
            ...
            puts "Telefono: #{an_appointment.phone}"
            if an_appointment.notes != " "
              puts "Notas: #{an_appointment.notes}"
            end
          rescue => exception
            warn exception.message
          end
      ...
      class CancelAll < Dry::CLI::Command
        ...
        def call(professional:)
          begin
            ...
            puts "Se cancelaron todos los turnos del profesional #{professional}"
          rescue => exception
            warn exception.message
          end
